...
- intros. destruct a.
  ...
  * simpl in H. apply IHl in H. destruct H. destruct s. destruct s. destruct p. subst.
    exists x. exists ([Bot V] ++ x0). exists x1. auto.
  * simpl in H. apply IHl in H. destruct H. destruct s. destruct s. destruct p. subst.
...
Lemma dec_box_in : forall s, (existsT2 (A : MPropF V), (In (Box A) (fst s)) /\ (Box A = snd s)) +
                             ((existsT2 (A : MPropF V), (In (Box A) (fst s)) /\ (Box A = snd s)) -> False).
Proof.
intro. destruct s.
induction l.
- right. intro. destruct H. destruct a. simpl in H. inversion H.
...
Lemma dec_GL4ip_init_rules : forall (s : (prod (list (MPropF V)) (MPropF V))) ,
...
Lemma dec_IdP_rule : forall (s : (prod (list (MPropF V)) (MPropF V))),
          (IdPRule [] s) +
          ((IdPRule [] s) -> False).
Proof.
intro s. destruct s. destruct (dec_prop_var_in (pair l m)).
...
Lemma dec_Id_rule : forall (s : (prod (list (MPropF V)) (MPropF V))),
          (IdRule [] s) +
          ((IdRule [] s) -> False).
Proof.
...
Lemma dec_BotL_rule : forall (s : (prod (list (MPropF V)) (MPropF V))),
          (BotLRule [] s) +
          ((BotLRule [] s) -> False).
Proof.
...
Lemma dec_init_rules : forall (s : (prod (list (MPropF V)) (MPropF V))),
          ((IdRule [] s) + (BotLRule [] s)) +
...
Lemma dec_is_and : forall (A : MPropF V), (existsT2 B C, A = And B C) + ((existsT2 B C, A = And B C) -> False).
Proof.
destruct A.
...
Lemma dec_and_in : forall (l : list (MPropF V)), (existsT2 A B, In (And A B) l) + ((existsT2 A B, In (And A B) l) -> False).
Proof.
induction l.
...
Lemma dec_AndR_rule : forall (concl : (prod (list (MPropF V)) (MPropF V))),
...
Lemma dec_AndL_rule : forall (concl : (prod (list (MPropF V)) (MPropF V))),
...
Lemma dec_is_or : forall (A : MPropF V), (existsT2 B C, A = Or B C) + ((existsT2 B C, A = Or B C) -> False).
Proof.
destruct A.
- right. intro. destruct H. destruct s. inversion e.
- right. intro. destruct H. destruct s. inversion e.
...
Lemma dec_or_in : forall (l : list (MPropF V)), (existsT2 A B, In (Or A B) l) + ((existsT2 A B, In (Or A B) l) -> False).
Proof.
induction l.
- right. intro. destruct H. destruct s. inversion i.
- destruct IHl.
...
Lemma dec_OrR1_rule : forall (concl : (prod (list (MPropF V)) (MPropF V))),
...
Lemma dec_OrR2_rule : forall (concl : (prod (list (MPropF V)) (MPropF V))),
...
Lemma dec_OrL_rule : forall (concl : (prod (list (MPropF V)) (MPropF V))),
...
Lemma dec_ImpR_rule : forall (concl : (prod (list (MPropF V)) (MPropF V))),
...
Lemma dec_is_atomimp : forall (A : MPropF V), (existsT2 P C, A = Imp # P C) + ((existsT2 P C, A = Imp # P C) -> False).
Proof.
...
Lemma dec_atomimp_in : forall (l : list (MPropF V)) P, (existsT2 B, In (Imp # P B) l) + ((existsT2 B, In (Imp # P B) l) -> False).
Proof.
induction l.
...
Lemma dec_atom_atomimp1_in : forall (l : list (MPropF V)), (existsT2 P B l0 l1, (In (# P) l0) * (In (Imp # P B) l1) * (l = l0 ++ l1)) +
...
Lemma dec_AtomImpL1_rule : forall (concl : (prod (list (MPropF V)) (MPropF V))),
...
Lemma dec_atom_atomimp2_in : forall (l : list (MPropF V)), (existsT2 P B l0 l1, (In (# P) l1) * (In (Imp # P B) l0) * (l = l0 ++ l1)) +
...
Lemma dec_AtomImpL2_rule : forall (concl : (prod (list (MPropF V)) (MPropF V))),
...
Lemma dec_is_andimp : forall (A : MPropF V), (existsT2 B C D, A = Imp (And B C) D) + ((existsT2 B C D, A = Imp (And B C) D) -> False).
Proof.
intro A. destruct (dec_is_imp A).
...
Lemma dec_andimp_in : forall (l : list (MPropF V)), (existsT2 A B C, In (Imp (And A B) C) l) + ((existsT2 A B C, In (Imp (And A B) C) l) -> False).
Proof.
induction l.
...
Lemma dec_AndImpL_rule : forall (concl : (prod (list (MPropF V)) (MPropF V))),
...
Lemma dec_is_orimp : forall (A : MPropF V), (existsT2 B C D, A = Imp (Or B C) D) + ((existsT2 B C D, A = Imp (Or B C) D) -> False).
Proof.
intro A. destruct (dec_is_imp A).
...
Lemma dec_orimp_in : forall (l : list (MPropF V)), (existsT2 A B C, In (Imp (Or A B) C) l) + ((existsT2 A B C, In (Imp (Or A B) C) l) -> False).
Proof.
induction l.
- right. intro. destruct H. repeat destruct s. inversion i.
- destruct IHl.
...
Lemma dec_OrImpL_rule : forall (concl : (prod (list (MPropF V)) (MPropF V))),
...
Lemma dec_is_impimp : forall (A : MPropF V), (existsT2 B C D, A = Imp (Imp B C) D) + ((existsT2 B C D, A = Imp (Imp B C) D) -> False).
Proof.
intro A. destruct (dec_is_imp A).
...
Lemma dec_impimp_in : forall (l : list (MPropF V)), (existsT2 A B C, In (Imp (Imp A B) C) l) + ((existsT2 A B C, In (Imp (Imp A B) C) l) -> False).
Proof.
induction l.
- right. intro. destruct H. repeat destruct s. inversion i.
- destruct IHl.
...
Lemma dec_ImpImpL_rule : forall (concl : (prod (list (MPropF V)) (MPropF V))),
...
Lemma dec_is_boximp : forall (A : MPropF V), (existsT2 B C, A = Imp (Box B) C) + ((existsT2 B C, A = Imp (Box B)C) -> False).
Proof.
intro A. destruct (dec_is_imp A).
...
Lemma dec_boximp_in : forall (l : list (MPropF V)), (existsT2 A B, In (Imp (Box A) B) l) + ((existsT2 A B, In (Imp (Box A) B) l) -> False).
Proof.
induction l.
- right. intro. destruct H. repeat destruct s. inversion i.
- destruct IHl.
...
Lemma dec_BoxImpL_rule : forall (concl : (prod (list (MPropF V)) (MPropF V))),
...
Lemma dec_GLR_rule : forall (concl : (prod (list (MPropF V)) (MPropF V))),
...
Lemma dec_GL4ip_rules : forall (concl : (prod (list (MPropF V)) (MPropF V))),
...
Lemma dec_PSGL4ip_rules : forall (concl : (prod (list (MPropF V)) (MPropF V))),
