...
Inductive init_switch_ind (s : list (MPropF V) * (MPropF V)) (n : nat) : Type :=
 | init : ((IdRule [] s) + (BotLRule [] s)) -> (n = 0) -> init_switch_ind s n
 | notinit : (((IdRule [] s) + (BotLRule [] s)) -> False) -> (n = 1) -> init_switch_ind s n.

Lemma dec_nat_init_switch_ind : forall (s : list (MPropF V) * (MPropF V)),
...
Definition init_switch (s: list (MPropF V) * (MPropF V)) : nat := proj1_sigT2 (dec_nat_init_switch_ind s).

Lemma init_switch_0_or_1 : forall (s : list (MPropF V) * (MPropF V)),
...
Definition subform_boxesS (s : (list (MPropF V)) * (MPropF V)) : list (MPropF V) :=
...
Lemma RHS_top_box_is_subformLF : forall (s : (list (MPropF V)) * (MPropF V)) (A : MPropF V),
...
Definition usable_boxes (s :(list (MPropF V)) * (MPropF V)) : list (MPropF V) :=
...
Lemma no_RHS_box_no_GLR (s : (list (MPropF V)) * (MPropF V)) :
...
Lemma all_RHS_boxes_are_LHS_boxes_no_GLR (s : (list (MPropF V)) * (MPropF V)) :
...
Lemma no_usable_boxes_all_RHS_are_LHS (s : (list (MPropF V)) * (MPropF V)) :
...
Theorem length_usable_boxes_is_0 (s : (list (MPropF V)) * (MPropF V)) :
...
Inductive weight_test_ind (n : nat) (A : MPropF V) (m : nat) : Type :=
...
Fixpoint occ_weight_list (n : nat) (l : list (MPropF V)) : nat :=
match l with
  | nil => 0
  | h :: t => (weight_test n h) + (occ_weight_list n t)
end.

Fixpoint list_occ_weight_list (n : nat) (l : list (MPropF V)): list nat :=
match n with
  | 0 => nil
...
Definition seq_list_occ_weight (s : list (MPropF V) * (MPropF V)) : list nat :=
...
Definition less_than3 (s0 s1 : list (MPropF V) * (MPropF V)) : Prop :=
...
Corollary less_than3_rect (P : (list (MPropF V) * (MPropF V)) -> Type)
...
forall P : (list (MPropF V) * (MPropF V)) -> Type,
(forall s0 : list (MPropF V) * (MPropF V), (forall s1 : list (MPropF V) * (MPropF V), ((s1 <3 s0) -> P s1)) -> P s0) ->
forall s : list (MPropF V) * (MPropF V), P s.
Proof.
intros P sIH.
assert (J: (forall s : list (MPropF V) * (MPropF V),
